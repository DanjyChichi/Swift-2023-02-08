...
//Any 타입 : 모든 데이터 타입을 담을 수 있음.
//        : 자바 최상위 타입 Object와 비슷함.
// 담을 수 있는 타입들
...
//스위프트에서는 변수에 기본적으로 직접 nil을 넣을 수 없음.
//var myNull = nil
...
//Swift는 null exception(널 오류)를 방지하기 위해 옵셔널 변수 등을 고안해 내었다. null에 대해서 고민을 많이 하고 태어난 언어다.
